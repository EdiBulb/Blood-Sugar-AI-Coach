...
export default function ProfileEditor({ onSaved }){
  const [form, setForm] = useState({ goals:'', diet:'', exercise:'', target_min:80, target_max:140 });
  ...
  async function save(){
    await axios.put("/api/profile", {
      goals: form.goals, diet: form.diet, exercise: form.exercise,
      target_min: Number(form.target_min), target_max: Number(form.target_max)
    });
    setSaved(true); 
